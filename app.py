...
api.add_resource(CoordinatorSolicitations, "/solicitations/coordinator")
api.add_resource(Advisors, "/advisors")
api.add_resource(AdvisorSolicitations, "/solicitations/advisor")
api.add_resource(SendMail, "/sendmail")
api.add_resource(StudentSolicitations, "/solicitations/student")
